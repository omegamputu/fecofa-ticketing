...
Vous avez été invité à rejoindre la plateforme **FECOFA Ticketing** pour la gestion de vos demandes et incidents.
...
@slot('subcopy')
© {{ date('Y') }} **FECOFA Ticketing**. Tous droits réservés.
