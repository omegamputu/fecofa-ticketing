<div>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('admin.users.create') }}" wire:navigate class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 px-3 py-2">+ Nouvel
            utilisateur</a>
    </div>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-2 border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-200 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('admin.users.edit',$u) }}" wire:navigate>Éditer</a>
                    <button class="font-medium text-red-600 dark:text-red-500 hover:underline" wire:click="delete({{ $u->id }})" onclick="return confirm('Supprimer ?')">Supprimer</button>
                </td>
            </tr>
            @endforeach
        </tbody>
