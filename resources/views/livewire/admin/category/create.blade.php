    ...
    <div class="grid auto-rows-min gap-3 md:grid-cols-3">
        <div class="border border-neutral-200 dark:border-neutral-700 rounded-lg p-4">
            ...
            <form wire:submit="save" class="space-y-4">
                ...
                <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Save</button>
            </form>
        </div>
    </div>
</div>
