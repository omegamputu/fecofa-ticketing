        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="rounded-xl p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                @foreach ($unassigned as $ticket)
                    <div class="rounded-xl mb-3 p-4 border border-neutral-200 dark:border-neutral-700">
            ...
            <div class="rounded-xl p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                @foreach ($resolved as $ticket)
                    <div class="rounded-xl mb-3 p-4 border border-neutral-200 dark:border-neutral-700">
                        <p class="text-sm mt-2 text-gray-500 dark:text-gray-400">#{{ $ticket->id }} - {{ $ticket->subject }} - {{ $ticket->priority }} - {{ $ticket->resolved_info }} </p>
                    </div>
                @endforeach
            </div>
        </div>
