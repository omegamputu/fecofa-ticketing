<div>
    <div class="grid grid-flow-row auto-rows-max gap-4 md:grid-cols-2">
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
            ...
            <div class="flex flex-row gap-2 md:gap-4 mt-3 text-sm text-zinc-600">
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
            ...
            <form wire:submit="addComment" class="mt-4 space-y-3">
                ...
                <button class="cursor-pointer focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    {{ __("Save") }}
                </button>
            </form>
            @endif
